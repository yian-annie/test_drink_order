...
if __name__ == "__main__":
    ...
    if "ice" not in resultDICT and "temperature" not in resultDICT:
        resultDICT["ice"] = []
        resultDICT["ice"].append("預設正常冰")
        
    if "ice" in resultDICT and "temperature" not in resultDICT:
        print("hello")
        print("您點的總共是：")
        for k in range(0,len(resultDICT["amount"])):
            print(resultDICT["item"][k],"X",resultDICT["amount"][k],"(",resultDICT["sugar"][k],"、",resultDICT["ice"][k],")")
        print("謝謝您的訂購")
    ...
    if "temperature" in resultDICT and "ice" not in resultDICT:
        ...
        print("您點的總共是：")
        for k in range(0,len(resultDICT["amount"])):
            print(resultDICT["item"][k],"X",resultDICT["amount"][k],"(",resultDICT["sugar"][k],"、",resultDICT["temperature"][k],")")
        print("謝謝您的訂購")
